...
if __name__ == "__main__":
    file_igbo= ["web_scraping/scrape_bbc_igbo.txt","web_scraping/scrape_igbo.von.gov.ng.txt","web_scraping/scrape_ted_talk_igbo.txt"]
    file_pidgin = ["web_scraping/scrape_bbc_pidgin.txt", "web_scraping/scrape_naijalingo.com.txt"]
